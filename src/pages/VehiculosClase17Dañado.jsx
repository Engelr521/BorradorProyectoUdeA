                    ...
                    {carros.map((carros) => {
                        return (
                            <tr >
                                ...
                                <td>
                                    <div className="input-group justify-content-center mb-6">
                                        <i type="number" className="form-control-tabla fas fa-pencil-alt"  aria-label="Editar" aria-describedby="basic-addon1"></i>
                                        <i type="number" className="form-control-tabla fas fas fa-trash"  aria-label="Eliminar" aria-describedby="basic-addon1"></i>
                                    </div>
                                </td>
                            </tr>
